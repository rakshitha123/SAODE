...
public class Multiple_AODE extends Classifier implements UpdateableClassifier {
    ...
    public void buildClassifier(Instances data) throws Exception {
        ...
        for (int i = 0; i < m_childClassifiers.length; ++i) {
            m_childClassifiers[i] = new AODE();  // Creating multiple AODE classifiers one per each season
