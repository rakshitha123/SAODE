...
public class Multiple_Hoeffding_Tree extends Classifier implements UpdateableClassifier {
    ...
    public void buildClassifier(Instances data) throws Exception {
        ...
        for (int i = 0; i < m_childClassifiers.length; ++i) {
            m_childClassifiers[i] = new HoeffdingTree();  // Creating multiple HoeffdingTree classifiers one per each season
